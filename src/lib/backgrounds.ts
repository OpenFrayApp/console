...
/** The bundled file for a backdrop id, or undefined for none and for ids we don't ship. */
export function backgroundFile(id: string | undefined): string | undefined {
  return CAMPAIGN_BACKGROUNDS.find((b) => b.id === id)?.file
}
