...
import { AddCreaturePicker } from '../add/AddCreaturePicker.tsx'
...
export function CustomMonsterForm({
  ...
  return (
    <>
      {open && (
        <FormModal
          title={editId ? 'Edit creature' : 'Custom creature'}
          ariaLabel={editId ? 'Edit creature' : 'Create custom creature'}
          maxWidth="max-w-xl"
          onClose={onClose}
        >
            ...
            <Section title="Skills, senses & languages">
                  ...
                  <div key={s.id} className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        patch({
                          skills: d.skills.map((x) =>
                            x.id === s.id ? { ...x, expertise: e.target.value === 'expertise' } : x,
                          ),
                        })
                      }
              ...
              <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                ...
                <input
                  ...
                  onChange={(e) => patch({ senses: { ...d.senses, tremorsense: e.target.value } })}
                        ...
                        onChange={(e) =>
                          patch({
                            spellGroups: d.spellGroups.map((x) =>
                              x.id === g.id ? { ...x, usage: e.target.value as typeof x.usage } : x,
                            ),
                          })
                        }
