 ...
 * compendium, as tabs. Hidden from `lg` up, where the three screens are the three
 * columns and the header's view toggle covers the compendium.
 */
export function MobileNav({
  ...
  return (
    <nav
      ...
      className="grid shrink-0 grid-cols-4 border-t border-slate-200 pb-[env(safe-area-inset-bottom)] dark:border-slate-800 lg:hidden"
    >
      <Tab
        icon={<RowsIcon />}
        label="Tracker"
